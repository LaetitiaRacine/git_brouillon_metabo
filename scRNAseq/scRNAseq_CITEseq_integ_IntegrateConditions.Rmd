...
list_seurat_obj_cc = integration_fun(list_seurat_obj_cc)
list_seurat_obj = integration_fun(list_seurat_obj)

```

```{r, Integration based on SCTransform normalization}

integration_sct_fun = function(list_obj) {
...
list_seurat_obj_cc = integration_sct_fun(list_seurat_obj_cc)
list_seurat_obj = integration_sct_fun(list_seurat_obj)

```

```{r, Save outputs}

saveRDS(list_seurat_obj_cc, paste0(directory_output, "integrate_seurat_obj_qc_norm_ccr.rds"))
saveRDS(list_seurat_obj, paste0(directory_output, "integrate_seurat_obj_qc_norm.rds"))
